...
/* Private defines -----------------------------------------------------------*/
#define CE5_Pin GPIO_PIN_0
#define CE5_GPIO_Port GPIOA
#define CS5_Pin GPIO_PIN_1
#define CS5_GPIO_Port GPIOA
#define CE6_Pin GPIO_PIN_2
#define CE6_GPIO_Port GPIOA
#define CS6_Pin GPIO_PIN_3
#define CS6_GPIO_Port GPIOA
#define CE7_Pin GPIO_PIN_4
#define CE7_GPIO_Port GPIOA
#define CS7_Pin GPIO_PIN_0
#define CS7_GPIO_Port GPIOB
#define CE8_Pin GPIO_PIN_1
#define CE8_GPIO_Port GPIOB
#define CS8_Pin GPIO_PIN_10
#define CS8_GPIO_Port GPIOB
#define CS4_Pin GPIO_PIN_11
#define CS4_GPIO_Port GPIOB
#define CE4_Pin GPIO_PIN_12
#define CE4_GPIO_Port GPIOB
#define CS3_Pin GPIO_PIN_13
#define CS3_GPIO_Port GPIOB
#define CE3_Pin GPIO_PIN_14
